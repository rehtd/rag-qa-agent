...
| 阶段 | 日期 | 内容 | 完成标准 |
|---|---|---|---|
| D1–2 | 8/15–16 | 环境、venv、DeepSeek ping、repo | hello 对话成功 |
| D3–6 | 8/17–20 | 42 条数据收集与复核 | 数据过验收 4 规则 |
| D7–8 | 8/21–22 | 索引 + RAG + Streamlit | 端到端 6 用例 |
| D9–10 | 8/23–24 | 路由 + held-out 测试集 + 基线 | 基线出炉 |
| D11–12 | 8/25–26 | 优化实验与评测报告 | 对比表完成 |
| D13 | 8/27 | PRD/README/录屏/STAR/.env 检查 | 交付物全绿 |
| D14 | 8/28 | 缓冲 + 面试准备 | — |
